    ...
    def get_page_config(self) -> dict[str, Any]:
        ...
        try:
            ...
            try:
                ...
                if (
                    self.serverapp.preferred_dir
                    and self.serverapp.preferred_dir != server_root
                ):
                    preferred_path = (
        ...
        recursive_update(
            page_config,
            get_page_config(labextensions_path, settings_dir, logger=self.log),
        )
...
def add_handlers(handlers: list[Any], extension_app: LabServerApp) -> None:  # noqa
    ...
    if extension_app.schemas_dir:
        ...
        if extension_app.translations_api_url:
            ...
            handlers.append(
                (translations_lang_path, TranslationsHandler, settings_config)
            )
    ...
    if extension_app.workspaces_dir:
        ...
        workspace_api_path = ujoin(
            extension_app.workspaces_api_url, "(?P<space_name>.+)"
        )
