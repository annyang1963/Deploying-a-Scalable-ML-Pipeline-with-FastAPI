    ...
    def _process_keyword_line(self, lineno, line, obsolete=False) -> None:
        for keyword in self._keywords:
            try:
                ...
                self._invalid_pofile(
                    line, lineno, "Keyword must be followed by a string"
                )
        else:
            self._invalid_pofile(
                line, lineno, "Start of line didn't match any expected keyword."
            )
            return
...
def _sort_messages(
    messages: Iterable[Message], sort_by: Literal["message", "location"]
) -> list[Message]:
    """
