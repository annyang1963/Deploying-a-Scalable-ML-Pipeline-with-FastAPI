    ...
    def put_tcp_frame(self, frame):
        ...
        while True:
            ...
            if self.message_pos == -1:
                ...
                self.message_pos = (
                    self.separator_pos + DebugpyMessageQueue.SEPARATOR_LENGTH
                )
            ...
            if len(self.tcp_buffer) - self.message_pos == self.message_size:
                ...
                self.tcp_buffer = self.tcp_buffer[
                    self.message_pos + self.message_size :
                ]
...
class DebugpyClient:
    ...
    def _send_request(self, msg):
        ...
        buf = (
            DebugpyMessageQueue.HEADER + content_length + DebugpyMessageQueue.SEPARATOR
        ).encode("ascii")
        buf += content
