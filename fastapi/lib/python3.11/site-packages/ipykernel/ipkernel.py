...
class IPythonKernel(KernelBase):
    ...
    debugpy_stream = (
        Instance(ZMQStream, allow_none=True) if _is_debugpy_available else None
    )
    ...
    def __init__(self, **kwargs):
        ...
        self.shell.displayhook.pub_socket = (
            self.iopub_socket
        )  # type:ignore[attr-defined]
        ...
        self.shell.display_pub.pub_socket = (
            self.iopub_socket
        )  # type:ignore[attr-defined]
    ...
    async def do_execute(
        ...
        *,
        ...
        err = (
            res.error_before_exec
            if res.error_before_exec is not None
            else res.error_in_exec
        )
