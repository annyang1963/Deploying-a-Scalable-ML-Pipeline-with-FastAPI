    ...
    def write_connection_file(self):
        ...
        if os.path.exists(cf):
            ...
            if connection_info == existing_connection_info:
                self.log.debug(
                    "Connection file %s with current information already exists", cf
                )
                return
    ...
    def init_connection_file(self):
        ...
        try:
            self.connection_file = filefind(
                self.connection_file, [".", self.connection_dir]
            )
        except OSError:
            self.log.debug("Connection file not found: %s", self.connection_file)
            # This means I own it, and I'll create it in this directory:
            os.makedirs(
                os.path.dirname(self.abs_connection_file), mode=0o700, exist_ok=True
            )
    ...
    def init_io(self):
        ...
        if self.outstream_class:
            ...
            sys.stdout = outstream_factory(
                self.session, self.iopub_thread, "stdout", echo=e_stdout
            )
    ...
    def patch_io(self):
        ...
        try:
            ...
            if hasattr(faulthandler, "register"):
                ...
                def register(
                    signum, file=sys.__stderr__, all_threads=True, chain=False, **kwargs
                ):
